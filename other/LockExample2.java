/*
 * Java 5 ReentrantLock Example 2.
 */
...
public class LockExample2 {
	...
	public static void main(final String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			threads[i] = new LockExampleThread2(i, lock);
		}
 ...
 */
class LockExampleThread2 extends Thread {
	
	private int id;
	private Lock lock;
	
	public LockExampleThread2(final int id, final Lock lock) {
		this.id = id;
		this.lock = lock;
	}
